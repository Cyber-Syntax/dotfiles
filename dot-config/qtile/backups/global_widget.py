...
def get_appimage_updates():
    """Custom function to get AppImage update status on my-unicorn cli tool.

    my-unicorn: CLI tool to manage AppImages written by me.
    """
    import subprocess
...
global_middle = [
    # TaskList is identical on both desktop and laptop
    space,
    widget.TaskList(
